# Windows 11 24H2 Initial Setup

---

## 1.1 Boot from ISO or Flash Drive, Preparing Setup

As of this release, using ISO ___"Win11_24H2_<Language>_x64.iso"___ is the recommended starting point for new installations.
...
3. Ensure the following entry is selected:
...
1. When prompted to "Select setup option", ensure ***"Install Windows 11"*** is selected.
2. Check the box labeled, ***"I agree everything will be deleted including files, apps, and settings."***
3. Click the ***"Next"*** button.
4. Enter your ***"Windows Product Key"*** in the "Enter Product key" textbox.

   Windows will then pause as it is, "Checking the key".
...
2. Click the ***"Accept"*** button after reading the "Applicable notices and license terms."
3. Click the ***"Next"*** button.

---

## 1.4 Windows Setup, Select location to install Windows 11
...
2. Click the **"Next"** button.
3. Verify that "Install Windows 11 Pro" and "Keep nothing" are what you wish to happen.
